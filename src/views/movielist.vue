        ...
        <div class="panel-body">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <button class="btn btn-success" type="button" @click="addMovie"><span class="glyphicon glyphicon-plus" />
                Add</button>
            </span>
          </div><!-- /input-group -->
        </div>
          ...
          <ul>
            <li v-for="(movieName,key) in movies" :key='key'>
              <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                  <button class="btn btn-sm btn-warning" @click="editMovie(key)"><span
                      class="glyphicon glyphicon-pencil"></span> Update</button>
                  <button class="btn btn-sm btn-danger" @click="deleteMovie(key)"><span
